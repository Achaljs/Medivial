...
import com.example.medivial.Service.WaterService
    ...
    private fun UI() {
        ...
        binding.save.setOnClickListener{
            if(check=="1")
            {
                ...
                Toast.makeText(this, "Water Reminder set successfully", Toast.LENGTH_SHORT).show()
               val Interval = (binding.interval.value*3600000).toLong()
                ...
                Toast.makeText(this, "Water Reminder removed successfully", Toast.LENGTH_SHORT).show()
